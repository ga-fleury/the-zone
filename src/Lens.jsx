...
export function Lens({ children, damping = 0.14, ...props }) {
  const ref = useRef();
  const { nodes } = useGLTF("https://auguri-webflow-react.s3.sa-east-1.amazonaws.com/lens-transformed2.glb");
  const buffer = useFBO();
...
useGLTF.preload("https://auguri-webflow-react.s3.sa-east-1.amazonaws.com/lens-transformed2.glb");
